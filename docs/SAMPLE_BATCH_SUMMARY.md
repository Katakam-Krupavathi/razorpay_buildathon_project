...
- **Cards Near Expiry (0–20 Days):** `11` instruments  
  *Triggers proactive card expiry notification and token migration rules in Risk Intelligence (Phase 4–6).*
- **UPI AutoPay Exceeding AFA Threshold:** `16` subscriptions  
  *Amounts exceeding RBI limit (₹15,000 standard or ₹1,00,000 MCC category) requiring step-up authentication.*
